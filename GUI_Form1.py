...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(100, 110, 691, 561))
        ...
        self.Password_Tb.setGeometry(QtCore.QRect(340, 430, 171, 20))
        self.Password_Tb.setObjectName("Password_Tb")
        self.Password_Lb = QtWidgets.QLabel(self.Dlib)
        self.Password_Lb.setGeometry(QtCore.QRect(270, 430, 61, 21))
        self.Password_Lb.setFrameShape(QtWidgets.QFrame.Panel)
        ...
        self.Stop_Btn_2.setGeometry(QtCore.QRect(230, 480, 71, 31))
        self.Stop_Btn_2.setObjectName("Stop_Btn_2")
        self.Start_Btn_2 = QtWidgets.QPushButton(self.Manual)
        self.Start_Btn_2.setGeometry(QtCore.QRect(120, 480, 81, 31))
        ...
        self.Lock_Lb_2.setGeometry(QtCore.QRect(340, 450, 41, 31))
        ...
        self.Password_Tb_2.setGeometry(QtCore.QRect(410, 490, 161, 20))
        self.Password_Tb_2.setObjectName("Password_Tb_2")
        self.Password_Lb_2 = QtWidgets.QLabel(self.Manual)
        self.Password_Lb_2.setGeometry(QtCore.QRect(340, 490, 61, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.username_Tb.setText(_translate("MainWindow", "UserName"))
        self.LeftTimeLabel.setText(_translate("MainWindow", "TextLabel"))
        self.DeleteUser_Btn.setText(_translate("MainWindow", "Delete User"))
        self.Password_Tb.setText(_translate("MainWindow", "Input Password here"))
        ...
        self.username_Tb_3.setText(_translate("MainWindow", "UserName"))
        ...
        self.Password_Tb_2.setText(_translate("MainWindow", "Input Password here"))
